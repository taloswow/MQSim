...
namespace SSD_Components
{
	...
	public:
		GC_and_WL_Unit_Page_Level(const sim_object_id_type& id,
				...
				bool use_copyback,
				double rho,unsigned int max_ongoing_gc_reqs_per_plane = 10, 
		...
		bool GCIsInUrgentMode(const NVM::FlashMemory::Flash_Chip*);

		void CheckGCRequired(const unsigned int free_block_pool_size, const NVM::FlashMemory::Physical_Page_Address& plane_address);
	private:
		NVM_PHY_ONFI * flash_controller;
	};
}
