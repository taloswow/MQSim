...
namespace SSD_Components
{
	...
	void Data_Cache_Manager_Base::SetupTriggers()
	{
		...
		host_interface->ConnectToUserRequestArrivedSignal(HandleUserRequestArrivedSignal);
	}
	...
	void Data_Cache_Manager_Base::ConnectToUserRequestServicedSignal(UserRequestServicedSignalHanderType function)
	{
		connected_user_request_serviced_signal_handlers.push_back(function);
	}
	
	void Data_Cache_Manager_Base::BroadcastUserRequestServicedSignal(User_Request* nvm_transaction)
	{
	...
	void Data_Cache_Manager_Base::ConnectToUserMemoryTransactionServicedSignal(MemoryTransactionServicedSignalHanderType function)
	{
		connected_user_memory_transaction_serviced_signal_handlers.push_back(function);
	}

	void Data_Cache_Manager_Base::BroadcastUserMemoryTransactionServicedSignal(NVM_Transaction* transaction)
	{
	...
	void Data_Cache_Manager_Base::HandleUserRequestArrivedSignal(User_Request* user_request)
	{
		_my_instance->ProcessNewUserRequest(user_request);
	}

	void Data_Cache_Manager_Base::SetHostInterface(Host_Interface_Base* host_interface)
	{
