...
public:
	...
	static uint16_t IO_Queue_Depth;
	...
	static SSD_Components::Cache_Sharing_Mode Data_Cache_Sharing_Mode;
	...
	static bool Ideal_Mapping_Table;
	...
	static unsigned int CMT_Capacity;
	// Size of SRAM/DRAM space that is used to cache address mapping table, the unit is bytes
	
	static SSD_Components::CMT_Sharing_Mode CMT_Sharing_Mode;
	...
	static double GC_Hard_Threshold;
	...
	static sim_time_type Preferred_suspend_erase_time_for_read;
	// in nano-seconds, if the remaining time of the ongoing erase is smaller than 
	// Prefered_suspend_erase_time_for_read, then the ongoing erase operation will be suspended
	
	static sim_time_type Preferred_suspend_erase_time_for_write;
	// in nano-seconds, if the remaining time of the ongoing erase is smaller than
	// Prefered_suspend_erase_time_for_write, then the ongoing erase operation will be suspended
	
	static sim_time_type Preferred_suspend_write_time_for_read;
	// in nano-seconds, if the remaining time of the ongoing write is smaller than
	// Prefered_suspend_write_time_for_read, then the ongoing erase operation will be suspended
