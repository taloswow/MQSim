...
public:
	...
	static sim_time_type SATA_Processing_Delay;
	// The overall hardware and software processing delay to send/receive
	// a SATA message in nanoseconds
	...
	// This parameter is not serialized. This is used to inform 
	// the Host_System class about the input file path.
