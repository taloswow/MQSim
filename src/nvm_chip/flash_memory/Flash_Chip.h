...
namespace NVM
{
	namespace FlashMemory
	{
		...
		public:
			...
			void ChangeMemoryStatusPreconditioning(const NVM_Memory_Address* address, const void* status_info);
			...
			sim_time_type GetCommandExecutionLatency(command_code_type CMDCode, flash_page_ID_type pageID)
			{
				int latencyType = 0;
			...
			LPA_type GetMetadata(flash_die_ID_type die_id,
